...
Core.prototype.displayAddRoomView = function() {
    ...
    $('#confirm-add-button').click(function(){
        ...
        var newRoom = {
	        name: encodeHTML(roomName),
	        name_abv: encodeHTML(roomAbv)
        };
...
Core.prototype.displayAddJudgeView = function(room_id, callback) {
    ...
    $('#confirm-add-button').click(function(){
        ...
        var newJudge = {
	        name: encodeHTML(judgeName),
	        subtitle: encodeHTML(judgeTitle),
    ...
    $('#confirm-add-button').click(function(){
		...
		fr.onload = function() {
			...
			for (var index in processedResults) {
				...
				var project = {};
				project['name'] = encodeHTML(result[0]);
				project['members'] = encodeHTML(result[1]);
				project['description'] = encodeHTML(result[2]);
